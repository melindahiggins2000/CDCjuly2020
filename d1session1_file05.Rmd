...
Let's look at the abalones heights and make a histogram. To start we need to specify which variable we will be plotting. We do this using the aes() or aestheitc command.
